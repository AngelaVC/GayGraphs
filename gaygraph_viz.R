...
trialname='for-talk-data-2011-12-20-10-45'
...
gaygraph_data_frame<-read.table(cat(trialname,'-edges-',start_end,sep=""))
nodes<-read.table(cat(trialname,'nodes-',start_end,sep=""))
...
# Plot the graph
jpeg(cat(trialname,'-',start_end,'.jpg',,sep=""))
plot(gaygraph, 
...
jpeg(cat(trialname,'-',start_end,'-gayonly','.jpg',,sep=""))
...
jpeg(cat(trialname,'-',start_end,'-straightonly','.jpg',,sep=""))
...
jpeg(cat(trialname,'-',start_end,'-comm0','.jpg',,sep=""))
...
jpeg(cat(trialname,'-',start_end,'-comm1','.jpg',,sep=""))
...
jpeg(cat(trialname,'-',start_end,'-comm2','.jpg',,sep=""))
...
jpeg(cat(trialname,'-',start_end,'-comm3','.jpg',,sep=""))
...
jpeg(cat(trialname,'-',start_end,'-comm4','.jpg',,sep=""))
